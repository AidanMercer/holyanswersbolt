    ...
    <div className="flex-1 bg-white dark:bg-gray-900 p-4 flex flex-col">
      ...
      <div className="flex items-center space-x-2 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
        <input 
          ...
          className="flex-1 p-2 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
        />
        <button 
          onClick={handleSendMessage}
          className="bg-holy-purple-600 text-white p-2 rounded-full hover:bg-holy-purple-700 transition-colors"
        >
          <Send size={20} />
        </button>
      </div>
